...
async function registerSlashCommands(client) {
  ...
  const commands = [
    ...
    new SlashCommandBuilder().setName("boost").setDescription("スパム送信テスト"),
      ...
      if (interaction.isChatInputCommand()) {
        ...
        if (name === "level") {
          ...
          if (sub === "set") {
            ...
            return interaction.reply(`✅ ${target.displayName} のレベルを ${lv} に設定`);
          }
        }
        ...
        if (name === "天気") {
          ...
          if (place) {
            ...
            return interaction.editReply(text || "⚠️ 天気取得失敗");
          }
        }
        ...
        if (name === "restore") {
          ...
          return interaction.editReply(ok ? "✅ 復元" : "⚠️ バックアップなし");
        }
