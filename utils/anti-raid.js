...
const cfg = {
  // ★ 修正: 閾値を緩和
  day: { THRESHOLD: 35, MASS_JOIN: 10, KEYWORD: 10, SIMILAR: 15, CMD_ABUSE: 20, REACT_SPAM: 10, NEWLINES: 20, ZALGO: 20, MASS_SPAM: 10, WEBHOOK: 25, AUDIT_ABUSE: 30, ACCOUNT_AGE: 15, },
  night: { THRESHOLD: 35, MASS_JOIN: 15, KEYWORD: 20, SIMILAR: 15, CMD_ABUSE: 20, REACT_SPAM: 10, NEWLINES: 15, ZALGO: 1, MASS_SPAM: 10, WEBHOOK: 30, AUDIT_ABUSE: 35, ACCOUNT_AGE: 20, }
};
